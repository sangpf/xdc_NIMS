...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <div class="button-group">
                <button type="button" onclick="addAuthor();" class="btn btn-default btn-sm">添加</button>
          ...
          <div class="box">
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <c:forEach items="${author_List }" var="author" varStatus="n">
	                 <tr>
	                  <td>
	                  	<input type="checkbox" name="checkniTweet" value="${author.id }">
	                  </td>
	                  <td>${n.index+1}</td>
	                  <td>${author.id }</td>
	                  ...
	                  <td><img style="width: 100px;height: 70px;" src="${author.headImg }"></td>
	                  <td>
	                  	  <input type="button" value="编辑" onclick="editAuthor(${author.id})">
	                  </td>
	                </tr>
                </c:forEach>
                </tbody>
 ...
 <script>
  //添加推文
  function addAuthor(){
	  window.location.href = "${ctx}/platform/addAuthor.do";
  }
  
  // 编辑推文 页面
  function editAuthor(authorId){
	  window.location.href = "${ctx}/platform/addAuthor.do?authorId="+authorId;
  }
