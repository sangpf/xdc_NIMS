...
<body class="hold-transition skin-blue ">
	...
	<div class="box box-primary">
		...
		<div class="box-footer">
			...
			<button type="button" onclick="replaceDaily3UpdateDelivery(${showOrder },${qnType })"
	...
	<script>
		...
		function searchQnTitleByIdForEdit(showOrder) {
			...
			if (deliveryId == "请输入投放Id" || deliveryId == ""
				...
				window.location.href = "${ctx}/platform/d3searchQnTitleByIdForEdit.do?deliveryId="
						+ deliveryId
						+ "&showOrder="
						+ showOrder
						+ "&qnType="
		...
		//在相同位置替换一条投放
		function replaceDaily3UpdateDelivery(showOrder,qnType) {
			var deliveryId = document.getElementById("deliveryId").value;
//			var qnType = document.getElementById("qnType").value;
			$
					.ajax({
						url : "${ctx}/platform/replaceDaily3UpdateDelivery.do",
						data : {
