...
public class Users extends Weibo {
	...
	//根据token 获取用户id
	public String getUserIdByToken() throws WeiboException{
		
		String url = WeiboConfig.getValue("baseURL")+"account/get_uid.json";
		
		Response response = client.get(url, 
				new PostParameter[] { new PostParameter("access_token", access_token) },
				access_token
				);
		...
		String userId = "";
		try {
			userId = asJSONObject.getString("uid");
