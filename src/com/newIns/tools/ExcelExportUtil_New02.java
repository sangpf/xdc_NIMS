...
public class ExcelExportUtil_New02 {
     ...
     * @throws Exception 
     */  
    public static void exportSXSSFExcel(String sheetName, List<CellMap> cellMapList, List<?> dataList, int rowAccessWindowSize,
     ...
     * @throws Exception 
     */  
    public static void exportSXSSFExcelFromMapData(String sheetName, List<CellMap> cellMapList, List<Map<String,String>> dataList,
    		int rowAccessWindowSize, OutputStream out) throws Exception {  
        SXSSFWorkbook workbook = new SXSSFWorkbook(rowAccessWindowSize);  
        Sheet sheet = workbook.createSheet(sheetName);  
        Row row = null;  
        Cell cell = null;  
...
//            ExcelExportUtil.exportSXSSFExcel(cellMapList, list, 1000, new FileOutputStream(new File("e:/test.xlsx")));  
     ...
     * @see [类、类#方法、类#成员] 
     */  
    public static int fillExcel_2007_SXSSF(CellStyle dataCellStyle,int cellSize,Sheet sheet,int rowIndex,SXSSFWorkbook workbook,
    		HttpServletResponse response,String excelName, List<CellMap> cellMapList, List<?> dataList) throws Exception{  
        Row row = null;  
        Cell cell = null;  
        int rowSize = (dataList == null) ? 0 : dataList.size();  
        for (int i = rowIndex; i < rowSize + rowIndex; i++) {  
...
//                            sheet.setColumnWidth(j, propertyValueLength);  
     ...
     * @see [类、类#方法、类#成员] 
     */  
//    public static void exportExcel_2007_SXSSF(HttpServletResponse response,String excelName,
//    		List<CellMap> cellMapList,String sql,Parameter param,BaseDao<?> baseDao,
//    		List<HashMap<String, Object>> foot) throws Exception{  
...
//    }  
     ...
     */  
//    public static void exportExcel_2007_SXSSF(HttpServletResponse response,String excelName,
//    		List<CellMap> cellMapList,String dataSql,Parameter dataParam,BaseDao<?> baseDao,
//    		List<HashMap<String, Object>> foot,String countSql,Parameter countParam) throws Exception{  
...
//    }  
     ...
     * @see [类、类#方法、类#成员] 
     */  
//    public static void exportExcel_2007_SXSSF(HttpServletResponse response,String excelName,List<CellMap> cellMapList,
//    		String sql,Parameter param,BaseDao<?> baseDao) throws Exception{  
...
//    }  
     ...
     * @see [类、类#方法、类#成员] 
     */  
//    public static void createExcel(HttpServletResponse response,String excelName, List<CellMap> cellMapList,
//    		String countSql, String sql,Parameter param,Parameter countParam,BaseDao<?> baseDao,
//    		List<HashMap<String, Object>> footers) throws Exception{  
