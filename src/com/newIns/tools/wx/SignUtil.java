...
//    public static boolean checkSignature2(String token,String signature, String timestamp,  
//            String nonce) {  
...
//    }  
    ...
    public static boolean checkSignature(String token, String signature, String timestamp, String nonce) {
    	System.out.println("微信签名 进入 checkSignature 方法中 ....进行判断   ");
        ...
        System.out.println("将sha1加密后的字符串可与signature对比，标识该请求来源于微信   ... ...");
